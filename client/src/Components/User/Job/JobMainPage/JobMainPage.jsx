  ...
  return (
    <>
      ...
      <div className="w-full md:h-[300px] md:text-start">
        <div className="bg-bgJobMainPage h-full rounded-xl px-6 py-8 md:py-20 relative overflow-hidden">
          {/* Main content */}
          <div className="md:flex md:px-10 md:items-start md:gap-6">
            ...
            <div className="flex-1">
              {/* Title */}
              <h2 className="text-2xl md:text-4xl font-normal text-gray-900 mb-4">
              ...
              <div className="flex flex-col md:flex-row md:flex-wrap gap-4 md:gap-6 mb-6">
                <div className="flex items-center gap-2">
                  ...
                  <span className=" text-gray-500">Newyork, USA</span>
                </div>
                <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className=" text-gray-500">1 Years Ago</span>
                </div>
                <div className="flex items-center gap-2">
                  <DollarSign className="w-5 h-5" />
                  <span className=" text-gray-500">$1000 - $2000 Monthly</span>
                </div>
              </div>
              ...
              <div className="flex flex-wrap gap-2">
                {["Creative", "User Interface", "Web Ui"].map((tag) => (
                  <span
                    key={tag}
                    className="px-5 py-1.5 rounded-md bg-bgwhite text-gray-600 text-sm hover:cursor-pointer"
                  >
                    {tag}
                  </span>
                ))}
