...
function ChangePassword() {
  ...
  return (
    ...
    <div className='py-10 px-4 flex flex-col text-start'>
    ...
    <label htmlFor="email" className='mt-2'>Email</label> <br />
    <input type="email" name="email" id="" className='p-3 border w-full mt-1'/>
    </div>
    <button className='p-3 bg-purple-500 mt-2 text-white lg:w-52 lg:mx-auto' onClick={()=>{
        Setvisibility('otp')
    }}>Continue</button>
    </div>
    </div>
