...
function MyResume() {
  ...
  return (
    <div>
      {/* <Navbar/> */}
      <div className='py-10 px-6 md:pl-10 md:pr-1 text-start w-full'>
        ...
        <div className='flex w-full flex-wrap gap-3 md:gap-4 mt-4'>
            <div className='w-5/12 md:w-3/12 lg:w-1/4'><AddResume/></div>
            {
              resumesData.map((resume,index)=>{
                return (
                  <div className='w-5/12 md:w-3/12 lg:w-1/4' key={index}>
